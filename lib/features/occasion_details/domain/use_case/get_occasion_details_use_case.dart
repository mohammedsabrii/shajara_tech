...
class GetOccasionDetailsUseCase {
  final OccasionDetailsRepo occasionDetailsRepo;

  GetOccasionDetailsUseCase({required this.occasionDetailsRepo});
  Future<Either<Failure, OccasionDetailsEntity>> call(int id) {
    return occasionDetailsRepo.getOccasionDetails(id);
  }
}
