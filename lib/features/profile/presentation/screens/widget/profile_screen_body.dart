...
import 'package:shajara_tech/features/profile/presentation/screens/widget/profile_screen_profile_picture_bloc_builder.dart';
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 18.h),
            const ProfileScreenProfilePictureBlocBuilder(),
