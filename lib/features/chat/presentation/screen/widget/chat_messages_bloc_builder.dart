    ...
    return Expanded(
      child: BlocBuilder<GetProfileInfoCubit, GetProfileInfoState>(
        builder: (context, profileState) {
          ...
          final myId = profileState.profileInfoEntity.userId;
              ...
              if (state is GetMessagesSuccess) {
                return ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final isMe =
                        message.messageSenderId.toString() == myId.toString();
                    return Align(
                      alignment: isMe
                          ? Alignment.centerRight
                          : Alignment.centerLeft,
                      child: isMe
                          ? ChatUserItem(message: message.messageContent)
                          : ChatFriendItem(message: message.messageContent),
                    );
                  },
                );
